							...
							<table class="bs-table" >
							  <tr>
								...
								<tr>
	                     		...
	                     		<td >
	                     			<input name="dept.id" id="deptId" type="hidden" value="${goods.dept.id}">
	                     			<input id="deptName" name="dept.dname" value="${goods.dept.dname}" readonly="readonly" class="form-control" style="width:50%;display:inline;float:left;"/>
