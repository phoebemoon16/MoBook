						...
						<form class="form-horizontal">
							...
							<table class="bs-table" >
							  <tr>
	                     		<td width="70">选择照片</td>
	                     		<td colspan="2"> 
	                     			<input class="form-control" type="hidden" id="imgUrl" style="width:78%;display:inline;float:left;" name ="imgUrl" type="text" value="${lockers.imgUrl}" readonly="readonly"/>
	                     			<img id="imgS" width="100" src="<%=path%>${lockers.imgUrl}" style="width:120px;"/>
								...
								<tr>
	                     		...
	                     		<td >
	                     			<input name="dept.id" id="deptId" type="hidden" value="${lockers.dept.id}">
	                     			<input id="deptName" name="dept.dname" value="${lockers.dept.dname}" readonly="readonly" class="form-control" style="width:50%;display:inline;float:left;"/>
