...
<section id="widget-grid" class="" style="background-image:url(img/r2.jpg);opacity:1;width:100%;margin-left:-10px;z-index:-50px;">
	<div class="row">
		...
		<form id="form-search" class="form-inline" method="post">
		  	...
		  	<div class="form-group">
		    	所属学院<k:dictSelect name="Q_EQI_inst.id" className="form-control" itemName="学院名称" headerKey=""/>
		    	<!--  图书名称<input type="text" style="width:120px;" class="form-control" name="Q_LKS_bookName"> -->
		  	</div>
		  	<!-- <div class="form-group">
		    	出售时间 <input type="text" style="width:120px;" class="form-control" onclick="WdatePicker()" name="Q_LED_card.endTime">
		  	</div> -->
	...
	$(function() {
		...
		grid.jqGrid({
			...
			colModel: [
				...
				{label: '卡号', name: 'card.cardNo', width: 50},
				{label: '所属学院', name: 'inst.iname', width: 50},
				{label: '联系方式', name: 'phone', width: 50},
				/* {label: '图书名称', name: 'bookName', width: 50}, */
				/* {label: '所买日期', name: 'card.beginTime', width: 50},
				{label: '出售日期', name: 'card.endTime', width: 50}, */
