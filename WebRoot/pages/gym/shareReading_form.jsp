							...
							<table class="bs-table" >
							  <tr>
								...
								<tr>
                     			...
                     			<td >
	                     			<input name="dept.id" id="deptId" type="hidden" value="${shareReading.dept.id}">
	                     			<input id="deptName" name="dept.dname" value="${shareReading.dept.dname}" readonly="readonly" class="form-control" style="width:100%;display:inline;float:right;"/>
