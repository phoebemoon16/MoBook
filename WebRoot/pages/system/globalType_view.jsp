...
<section id="widget-grid" class="" style="background-image:url(img/r2.jpg);opacity:1;width:100%;margin-left:-10px;z-index:-50px;">
	<div class="row">
		...
		<form id="form-search" class="form-inline" method="post">
		  	...
		  	<div class="form-group">
		    	类别<input type="text" style="width:120px;" class="form-control" name="Q_LKS_type">
		  	</div>
			...
			colModel: [
				...
				{label: '操作', name: 'id', width: 80, formatter: function(v) {
					return '<a href="javascript:editfunc('+v+')" class="btn btn-primary btn-xs">编辑</a>' +
							...
							'<a href="javascript:delfunc('+v+')" style="margin-left:10px;" class="btn btn-danger btn-xs">详情</a>';			
				}},
				{label: '图书名称', name: 'name', width: 50, editable: true},
				//{label: '商家', name: 'sellname', width: 50, editable: true},
				//{label: '类别', name: 'category', width: 50},
				{label: '借书人', name: 'perName', width: 50, editable: true},
				{label: '借书人联系方式', name: 'tell', width: 50, editable: true},
				{label: '借阅日期', name: 'bdate', width: 50},
				{label: '归还日期', name: 'ddate', width: 50},
