					...
					<form class="form-horizontal">
	                    ...
	                    <table class="bs-table">	                     	
	                     	...
	                     	<tr>
	                     		...
	                     		<%-- <td width="70">所属学院:</td>
	                     		<td>
	                     			<input name="inst.id" id="instId" type="hidden" value="${user.inst.id}">
	                     			<input id="instName" value="${user.inst.iname}" readonly="readonly" class="form-control" style="width:80%;display:inline;float:left;"/>
