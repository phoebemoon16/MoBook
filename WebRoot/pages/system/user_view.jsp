...
<!-- widget grid -->
<section id="widget-widget" class="" style="background-image:url(img/r2.jpg);opacity:1;width:100%;margin-left:-10px;z-index:-50px;">
	<div class="row">
	...
	$(function() {
		...
		grid.jqGrid({
			...
			colModel: [
				...
				{label: '学院类别', name: 'dept.dname', width: 100}
			],
			pager: '#pager',
			multiboxonly: true,
